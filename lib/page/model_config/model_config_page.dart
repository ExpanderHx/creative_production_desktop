...
class _ConfigPageState extends State<ModelConfigPage> {
    ...
    if(null!=activeChatModelConfig&&null!=widget.activeType){
      if(null!=activeChatModelConfig!.isLocal&&activeChatModelConfig!.isLocal!){
        ...
        if(null==activeChatModelConfig!.token||activeChatModelConfig!.token!.length<=0){
          var cancel = BotToast.showText(text:"请输入openai token");
          return;
        }
      ...
      BotToast.showText(text:"模型重新加载成功");
  ...
  List<Widget> getFormItemList(){
    ...
    widgetList.add(getInputRowWidget("模型名称 : ",
    ...
    if(activeChatModelConfig!.isLocal!=null&&activeChatModelConfig!.isLocal!){
      widgetList.add(getInputRowWidget("tokenizer : ",
      ...
      widgetList.add(getInputRowWidget("device:",
      ...
      widgetList.add(getInputRowWidget("base url:",
      ...
      widgetList.add(getInputRowWidget("token:",
    ...
    widgetList.add(getInputRowWidget("maxToken:",
    ...
    widgetList.add( getInputRowWidget("temperature:",
